...
- проверить кеширование на сервере cashe control всех запросов
- сделать отдельную страницу кино
- найти анализ композиции серверных и клиентских компонентов
- разобраться с неймингом файлов и папок
